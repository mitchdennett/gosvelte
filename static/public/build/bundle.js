...
(function () {
    ...
    /* static/src/App.svelte generated by Svelte v3.24.0 */

    const file = "static/src/App.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			this.c = noop;
    			add_location(h1, file, 28, 1, 344);
    			attr_dev(a, "href", "https://svelte.dev/tutorial");
    			add_location(a, file, 31, 2, 386);
    			add_location(p, file, 29, 1, 368);
    			add_location(main, file, 27, 0, 336);
    		},
    ...
    /* static/src/Blog.svelte generated by Svelte v3.24.0 */

    const file$1 = "static/src/Blog.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "Hello Blogger";
    			this.c = noop;
    			add_location(h1, file$1, 28, 1, 328);
    			add_location(main, file$1, 27, 0, 320);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<my-blog> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("my-blog", $$slots, []);
    	return [];
    }

    class Blog extends SvelteElement {
    	constructor(options) {
    		super();
    		this.shadowRoot.innerHTML = `<style>main{text-align:center;padding:1em;max-width:240px;margin:0 auto}h1{color:#ff3e00;text-transform:uppercase;font-size:4em;font-weight:100}@media(min-width: 640px){main{max-width:none}}</style>`;
